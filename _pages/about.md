...
> 💡 이 페이지는 [Cursor](https://cursor.sh) AI와 함께 작성했습니다! <br>
> 평소 제 블로그 말투와 좀 다를 수 있는데, 그래도 애교 있게 봐주세요 😊
...
### **BeWell** (Side Project, 2025.01 ~ 현재)
...
- **지속 가능한 플랫폼**: 개발자가 행복하게 쓸 수 있는 AI 시스템 만들기
