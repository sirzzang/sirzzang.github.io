...
![db-replication-primary-standby]({{site.url}}/assets/images/db-replication-primary-standby.png){: .align-center}
...
![db-replication-primary-standby-basic]({{site.url}}/assets/images/db-replication-primary-standby-basic.png){: .align-center}
...
![db-replication-primary-standby-split-readonly]({{site.url}}/assets/images/db-replication-primary-standby-split-readonly.png){: .align-center}
