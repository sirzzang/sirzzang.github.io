...
![cnn-cross-correlation-vs-convolution]({{site.url}}/assets/images/cnn-cross-correlation-vs-convolution.png){: .width="600"}{:. align-center}
...
![cnn-1d-2d-3d-convolution]({{site.url}}/assets/images/cnn-1d-2d-3d-convolution.png){: .width="600"}{:. align-center}
...
![cnn-feature-map-computation]({{site.url}}/assets/images/cnn-feature-map-computation.png){: width="400" height="400"}{: .align-center}
...
![cnn-upsampling-flatten-fc]({{site.url}}/assets/images/cnn-upsampling-flatten-fc.png){: .width="600"}{:. align-center}
...
![cnn-conv2d-maxpool-transpose-excel-example]({{site.url}}/assets/images/cnn-conv2d-maxpool-transpose-excel-example.png){: .width="600"}{:. align-center}
