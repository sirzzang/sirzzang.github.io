...
- `br-80cb5a0c07bc`: Docker Compose에 의해 생성된 Virtual Interface. `172.22.0.1/16` 대역의 IP를 처리한다. Host와 분리된 네트워크 영역이다.
  - 해당 네트워크에 바인딩되는 Docker Container가 생성될 때마다 `172.22.0.1/16`  대역에서 IP를 할당한다.
