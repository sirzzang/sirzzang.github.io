...
excerpt: "쿠버네티스에서 스왑 비활성화가 권장되는 이유와 최신 NodeSwap 기능을 알아보자."
categories:
  - Kubernetes
toc: true
header:
...
> 메모리, 페이지, 스왑의 기본 개념은 [메모리, 페이지, 스왑](/cs/CS-Memory-Page-Swap/)을, 컨테이너 환경에서의 메모리 관리는 [컨테이너와 메모리](/dev/Dev-Container-Memory/)를 참고하자.
