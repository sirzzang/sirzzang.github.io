...
![gan-discriminator-generator-diagram]({{site.url}}/assets/images/gan-discriminator-generator-diagram.png){: .align-center}
...
![gan-log-function]({{site.url}}/assets/images/gan-log-function.png){: .align-center}
...
![gan-training-algorithm-pseudocode]({{site.url}}/assets/images/gan-training-algorithm-pseudocode.png){: width="500"}{: .align-center}
...
![gan-distribution-convergence-stages]({{site.url}}/assets/images/gan-distribution-convergence-stages.png){: width="500"}{: .align-center}
