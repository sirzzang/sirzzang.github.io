...
- **[Using AWS IAM with STS as an Identity Provider (Medium)](https://medium.com/datamindedbe/using-aws-iam-with-sts-as-an-identity-provider-f5177ca0850c)**: EKS뿐 아니라 HashiCorp Vault도 동일한 패턴을 사용한다는 점을 설명한다.
- **[Understanding EKS Authentication (ITNEXT)](https://itnext.io/understanding-eks-authentication-from-kubectl-to-kubernetes-rbac-56bc533f46ba)**: 토큰 생성 과정을 단계별로 설명한다.
