---
title:  "[Kubernetes] Pod CPU Limit과 FFmpeg Thread 최적 조정 - 4.1. 문제 원인 파악: 현상 관찰"
...
| 항목 | Before (요청 처리 전) | After (요청 처리 후) | Delta |
|------|---|---|---|
| usage_usec | 4,363,848 | 124,702,078 | 120,338,230 |
| user_usec | 2,201,217 | 117,993,908 | 115,792,691 |
| system_usec | 2,162,630 | 6,708,170 | 4,545,540 |
| nr_periods | 3,106 | 4,499 | 1,393 |
| nr_throttled | 0 | 1,194 | 1,194 |
| throttled_usec | 0 | 263,624,194 | 263,624,194 |
...
> 여기까지 원인을 파악하는 데에만 꽤 많은 시간을 들였다. 하지만 원인을 제대로 이해하지 못한 채 해결책부터 찾으면, 결국 "감"에 의존하게 되고 같은 문제를 다른 형태로 반복하게 된다. 이번에는 원인을 확실히 잡고 넘어갔으니, 최적의 해결책을 찾을 수 있으리라 기대한다.
