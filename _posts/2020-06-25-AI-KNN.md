...
![knn-classification-example]({{site.url}}/assets/images/knn-classification-example.png){: .align-center}
...
![knn-distance]({{site.url}}/assets/images/knn-distance-formulas.png){: .align-center}
