---
title: "[EKS] EKS: 인증/인가 - 3. EKS 인증(AuthN) 실습"
excerpt: "EKS 인증 과정을 단계별로 실습하며, 토큰 생성부터 STS 검증까지의 전 과정을 직접 확인해 보자."
categories:
  - Kubernetes
toc: true
header:
...
*이전 포스트: [EKS: 인증/인가 - 2. EKS 인증/인가 전체 흐름]({% post_url 2026-04-02-Kubernetes-EKS-Auth-02-00-EKS-Auth-Overview %})*
