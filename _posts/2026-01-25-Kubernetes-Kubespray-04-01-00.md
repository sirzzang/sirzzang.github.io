...
> **참고**: [프로젝트 구조 Overview]({% post_url 2026-01-25-Kubernetes-Kubespray-04-00 %})에서 `kubespray_defaults`와 `kubespray-defaults`의 차이를 설명했다. `kubespray_defaults`는 변수 **값**을 정의하고, `kubespray-defaults`는 변수를 **로드**하는 태스크를 담고 있다.
