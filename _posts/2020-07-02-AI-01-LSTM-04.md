...
| merge_mode |                    예측 결과                     |
| :--------: | :----------------------------------------------: |
|   concat   | ![img]({{site.url}}/assets/images/bilstm-concat.png) |
|    sum     |  ![img]({{site.url}}/assets/images/bilstm-sum.png)   |
|    mul     |  ![img]({{site.url}}/assets/images/bilstm-mul.png)   |
|    ave     |  ![img]({{site.url}}/assets/images/bilstm-ave.png)   |
