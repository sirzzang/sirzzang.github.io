...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![distribution]({{site.url}}/assets/images/gan-keras-distribution.png) | ![discriminator]({{site.url}}/assets/images/gan-keras-discriminator-real-vs-fake.png) |
...
|                         distribution                         |                     discriminated values                     |
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| ![distribution]({{site.url}}/assets/images/gan-keras-distribution-two.png) | ![discriminator]({{site.url}}/assets/images/gan-keras-discriminator-real-vs-fake-two.png) |
