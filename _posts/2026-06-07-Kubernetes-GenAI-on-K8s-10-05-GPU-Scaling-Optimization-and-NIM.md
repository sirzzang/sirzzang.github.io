...
[이전 글]({% post_url 2026-06-07-Kubernetes-GenAI-on-K8s-10-04-GPU-Sharing-MPS-and-Time-Slicing %})에서 MPS와 time-slicing을 통한 GPU 공유 기법을 다뤘다. 이번 글에서는 DCGM 메트릭을 활용한 GPU 워크로드 오토스케일링과 NVIDIA NIM을 정리하며 Ch10을 마무리한다.
...
![NVIDIA NIM 컨테이너 구성]({{site.url}}/assets/images/genai-on-k8s-ch10-nvidia-nim-architecture.png){: .align-center}
