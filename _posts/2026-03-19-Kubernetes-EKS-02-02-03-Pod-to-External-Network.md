...
| 2 | eth0 → veth | src=`192.168.4.248`, dst=`8.8.8.8` | [veth pair]({% post_url 2026-03-19-Kubernetes-EKS-02-00-01-Pod-to-Pod-Networking %}#veth-pair로-네임스페이스-벽을-관통한다)를 통해 노드 네임스페이스로 전달 |
