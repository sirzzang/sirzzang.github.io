...
![cross entropy]({{site.url}}/assets/images/cross-entropy-formula.png){: .align-center}
...
![cross-entropy-vs-mse-comparison]({{site.url}}/assets/images/cross-entropy-vs-mse-comparison.png){: .align-center}
