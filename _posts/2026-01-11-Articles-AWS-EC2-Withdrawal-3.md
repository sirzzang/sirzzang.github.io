...
[이전 글]({% post_url 2026-01-08-Articles-AWS-EC2-Withdrawal-2 %})에서 AWS EC2 철수를 위한 대안을 검토하고, 최종 결정을 내리는 과정을 다뤘다. 이 글에서는 전체 의사결정 과정을 돌아보며 배운 점을 정리한다.
...
3편에 걸쳐 AWS EC2 인프라 철수를 결정하기까지의 과정을 기록했다.

**1편 - 현황 분석 및 문제 제기:**
- AWS 사용 현황 분석
- 월 약 80만 원 비용 발생
- 클라우드 핵심 가치 미활용 문제 제기

**2편 - 대안 분석 및 결정:**
- Right-sizing, 타 클라우드, 온프레미스 대안 비교
- Model Repository S3 전환 검토
- 최종 결정: EC2 철수, S3 사용
