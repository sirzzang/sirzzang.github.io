...
![K8s device plugin 아키텍처]({{site.url}}/assets/images/genai-on-k8s-ch10-device-plugin-architecture.png){: .align-center}
...
![NVIDIA device plugin DaemonSet]({{site.url}}/assets/images/genai-on-k8s-ch10-lab-nvidia-daemonsets.png){: .align-center}
